...
const Header = () => {
  return (
    <>
      {/* Top Bar */}
      <div className="bg-[#2A2A2A] text-white flex flex-col md:flex-row justify-center md:justify-end items-center gap-2 md:gap-4 text-xs sm:text-sm py-2 md:py-3 px-4 md:pr-20">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-0 xs:gap-1">
          <p className="font-semibold mr-1">Email Now:</p>
          <p className="break-all">info@appstackstudios.com</p>
        </div>
      </div>
      {/* Logo Bar */}
      <div className="py-2 flex justify-start px-4 md:px-0">
        <img
